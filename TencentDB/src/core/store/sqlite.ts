 ...
 *
 * Example (with jieba):
 *   "I enjoy programming with TypeScript" → '"I" OR "enjoy" OR "programming" OR "TypeScript"'
 * Example (fallback):
 ...
 * For example, "artificial intelligence" is indexed as
 * "artificial intelligence", so queries for either the full phrase or its
 * component words will match.
 *
